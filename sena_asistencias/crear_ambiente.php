...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Ambiente creado exitosamente'); window.location.href = 'dashboard.php';</script>";
    } else {
        echo "<script>alert('Error al crear el ambiente');</script>";
    }
}
?>
<!DOCTYPE html>
...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-96">
        <h1 class="text-2xl font-bold mb-6 text-center">Crear Ambiente</h1>
        <form action="crear_ambiente.php" method="POST">
            <div class="mb-4">
            ...
            <button type="submit" class="w-full bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Crear Ambiente</button>
        </form>
    </div>
</body>
</html>